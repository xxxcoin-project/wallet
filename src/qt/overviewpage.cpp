...
void OverviewPage::on_push1Button_clicked()
{
    //ui->push1Button->setText(QString("Clicked 1 me"));
    QDesktopServices::openUrl(QUrl("http://www.xxxcoincams.com"));

}

void OverviewPage::on_push2Button_clicked()
{
    //ui->push2Button->setText(QString("Clicked 2 me"));
    QDesktopServices::openUrl(QUrl("https://bitcointalk.org/index.php?topic=712912.msg8054890#msg8054890"));
}
